...
window.onload = function () {
  ...
  document.querySelector("body").addEventListener("mousemove", function (evt) {
    var eye = document.querySelectorAll(".eyes");
    eye.forEach(function (eye) {
      var x = eye.getBoundingClientRect().left + eye.clientWidth / 2;
      var y = eye.getBoundingClientRect().top + eye.clientHeight / 2;
      var radian = Math.atan2(evt.pageX - x, evt.pageY - y);
      var rotate = radian * (180 / Math.PI) * -1 + 270;
      eye.style.transform = "rotate(" + rotate + "deg)";
    });
  }); // Eyes follow caret in input field when user types

  var getCaretCoordinates = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'textarea-caret'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/******/ });
//# sourceMappingURL=app-baffb95d104f7030af9d.js.map