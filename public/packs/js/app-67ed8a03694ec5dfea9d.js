...
document.querySelector("body").addEventListener("mousemove", eyeball(poo));

function eyeball(poo) {
  ...
  eye.forEach(function (eye) {
    ...
    var radian = Math.atan2(poo.pageX - x, poo.pageY - y);
...
/******/ });
//# sourceMappingURL=app-67ed8a03694ec5dfea9d.js.map